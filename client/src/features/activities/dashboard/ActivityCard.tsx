        ...
        <Card elevation={2} sx={{ borderRadius: 3 }}>
            ...
            <CardContent sx={{ p: 0 }}>
                <Box display='flex' alignItems='center' mb={2} px={2}>
                    <Box display='flex' flex-grow={0} alignItems={'center'}>
                        <AccessTime sx={{ mr: 1 }} />
                ...
                <Divider />
                <Box display='flex' gap={2} sx={{ backgroundColor: 'grey.200', py: 3, pl: 3 }}>Attendees go here</Box>
            </CardContent>

            <CardActions sx={{ pb: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                <Typography variant="body2">
