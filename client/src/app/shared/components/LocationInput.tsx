...
import { LocationIQSuggestion } from "../../../lib/types/index";
...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const locationUrl = 'https://api.locationiq.com/v1/autocomplete?key=pk.260c6753f8e3f766c11ed6449298e6b5&limit=5&dedupe=1&'
